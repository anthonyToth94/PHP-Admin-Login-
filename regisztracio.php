		...
		<main>
			<div id="container">
				<div id="wrapper">
					...
					<div class="egySor"><input type="password" name="jelszo2" placeholder="Jelszó ismét" autocomplete="off" value="" id="jelszo2"></div>

					<div class="egySor" style="text-align:center;"><span style="font-size:20px;color:orange" id="hiba"> </span></div>
					<div id="submitGomb"><input type="button" name="regisztracio" value="Regisztráció" id="regisztracio" ></div>
				</form>
				</div>
			</div>
		</main>
